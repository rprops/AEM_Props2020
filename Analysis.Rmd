...
```{r EMIRGE-analysis-2, warning = FALSE, fig.width = 9, fig.height = 9, dpi = 500}
# Plot
p_emirge_abund_otu97 <- ggplot(EMIRGE_OTU, aes(x = OTU_97, y = 100*Prior_norm_OTU97, fill = OTU_97))+
  theme_bw()+
...
print(p_emirge_abund_otu97)

# Plot
p_emirge_abund_otu99 <- ggplot(EMIRGE_OTU, aes(x = OTU_97, y = 100*Prior_norm_OTU97, fill = OTU_97))+
  theme_bw()+
  geom_point(size = 4, shape = 21, color = "black", alpha = 0.7)+
  scale_fill_manual("", values = fill_palette)+
  theme(axis.text=element_text(size=14), axis.title=element_text(size=20),
...
print(p_emirge_abund_otu99)

# Plot
p_emirge_abund_seq <- ggplot(EMIRGE_OTU, aes(x = OTU_97, y = 100*Prior_norm_OTU97, fill = OTU_97))+
  theme_bw()+
  geom_point(size = 4, shape = 21, color = "black", alpha = 0.7)+
  scale_fill_manual("", values = fill_palette)+
  theme(axis.text=element_text(size=14), axis.title=element_text(size=20),
