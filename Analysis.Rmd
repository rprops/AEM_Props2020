...
```{r MAG8-DESeq-4, dpi = 500, warning = FALSE, fig.width = 5, fig.height = 5.5, dev = c("png","pdf")}
...
```{r desman-3, dpi = 500, warning = FALSE, fig.width = 7, fig.height = 5, dev = c("png","pdf")}
# Make PCoA
...
```{r desman-5, dpi = 500, warning = FALSE, fig.width = 7.5, fig.height = 6, dev = c("png","pdf")}
# Long to wide
...
```{r MAG8-DESeq-plot-upset1, dpi = 500, warning = FALSE, fig.width = 9, fig.height = 7, dev = c("png","pdf")}
# Extract 
