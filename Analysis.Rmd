...
```{r MAG8-DESeq-4, dpi = 500, warning = FALSE, fig.width = 5, fig.height = 7, dev = c("png","pdf")}
...
```{r MAG8-DESeq-5, dpi = 500, warning = FALSE, fig.width = 9, fig.height = 7, dev = c("png","pdf")}
