...
if (i == 1) {
  ...
  results_PCA_var <-
    ...
    PC = colnames(pca_exp_res$rotation)[1:2]
    )
} else {
...
png("./Figures/Revisions/Figure3.png", width = 7, height = 5, units = "in", res = 500)
print(p_deseq_overview)
dev.off()

svg("./Figures/Revisions/Figure3.svg", width = 7, height = 5)
print(p_deseq_overview)
dev.off()
